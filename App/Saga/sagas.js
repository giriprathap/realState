...
function* getAllAgencyList(action) {
	...
	try {
		...
		var responseJSON = yield call(_extJSON, response.res_json);
		console.log('get getAllAgencyList res: ' + JSON.stringify(responseJSON));
		yield put({
...
function* getAssociateWithAgency(action) {
	...
	try {
		...
		var responseJSON = yield call(_extJSON, response.res_json);
		console.log('getAssociateWithAgency res: ' + JSON.stringify(responseJSON));
		yield put({
...
function* acceptAndDeniedMaintenanceReq(action) {
	...
	try {
		...
		var responseJSON = yield call(_extJSON, response.res_json);
		console.log('acceptAndDeniedMaintenanceReq res: ' + JSON.stringify(responseJSON));
		yield put({
