...
class PropertiesDetailsScreen extends Component {
    ...
    render() {
        ...
        var marker = {                            
            LatLng: LatLng,
            title: this.state.propertyDetailData.data?this.state.propertyDetailData.data[0].address:'',
            ...
            <View>
                <ScrollView>
                    <View style={PropertiesDetailsScreenStyle.profileContainer}>
                        ...
                        {
                             this.state.userPermission.includes('edit_property')?<View style={PropertiesDetailsScreenStyle.optionViewContainer}>
