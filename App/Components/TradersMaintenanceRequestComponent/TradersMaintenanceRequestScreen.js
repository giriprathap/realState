...
class TradersMaintenanceRequestScreen extends Component {
    ...
    onAcceptAndRejectReqSuccess() {
        ...
        if (this.props.tradersMaintenanceReducer.acceptRejectReqRes != '') {
            console.log('response data', JSON.stringify(this.props.tradersMaintenanceReducer.acceptRejectReqRes));
    ...
    renderItem({ item, index }) {
        console.log('trader maintenance item ==',JSON.stringify(item));
